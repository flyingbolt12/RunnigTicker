...
function submitForm(id){
	dhtmlx.message({type:"error", expire:6000, text:"Downloading CSV...Please wait!!" });
	document.forms[0].businessId.value = id;
	document.forms[0].submit();
}

</script>
<form action="superAdminFunctImpl.do?parameter=downloadDoBackUpData" method = "post">
...
<table border="0" cellspacing="1" width="100%"
	...
	<tr height="25" style="vertical-align: middle;">
		...
		<td align="center" class="tdStyle"><pre class="pre">Back Up</pre></td>
	</tr>
	...
	<logic:iterate id="listAllBusinessId" name="listAllBusiness">
		...
		<tr>
			...
			<td align="center" bgcolor="#EFEFEF"><input type="button"
				value="Do Download" name="active" class="ButtonStyle"
				onclick="submitForm('<%=businessId%>')"></td>
		</tr>
	</logic:iterate>
