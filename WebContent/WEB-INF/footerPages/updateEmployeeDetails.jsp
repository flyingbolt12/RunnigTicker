...
if(document.forms[0].R1[0].checked==true){
	document.forms[1].action ="employeeUpdation.do";
	document.forms[1].submit();
	}
...
<p><input type="radio" value="employeeUpdate"  name="R1"  onclick="javascript:work()">Bank 
Details</p>
<p><input type="radio" value="employeeUpdate"  name="R1"  onclick="javascript:work()">Personal 
Details </p>
<p><input type="radio" value="employeeUpdate"  name="R1"  onclick="javascript:work()">Client 
Details</p>
