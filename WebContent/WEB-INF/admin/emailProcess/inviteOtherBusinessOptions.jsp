...
<div align="center">
<form action="inviteotherBusiness.do">
<input type="hidden" name="parameter" value="inviteOtherBusiness">
<table border="0" width="783" height="88" style="font-family: Tahoma; font-size: 10pt">
	<tr>
		...
		<p align="center"><font color="#FFFFFF" size="2" face="Tahoma"><b>Invite Other Business</b></font></td>
	</tr>
	<tr>
		<td height="36" width="346"><font size="2" face="Tahoma">Enter Email Id (Seperated by 
		Comma (,))<br>
		eg: one@gmail.com,2@yahoo.com</font></td>
		<td height="36" width="427">
		<textarea rows="7" name="emailsList" cols="65" class="BussinessTextBox"  ></textarea><html:errors/></td>
	</tr>
	<tr>
		<td height="23" width="773"  bgcolor="#F4F4F4" colspan="2">
		<p align="center">
...
function cancelRequest(){
	document.forms[0].action = "adminFunctImpl.do";
