...
<input type="hidden" name="parameter" value="sendGenericEmailToSingleEmployee">
<input type="hidden" name="userId" value="<%= (String)request.getParameter("userId")%>">
	<div align="center">
	<html:errors/>
		<table border="0" width="80%" style="font-family: Tahoma; font-size: 10pt" cellspacing="3" cellpadding="3">
			<tr>
				<td class="tdSideHeader" colspan="2">
					<p align="center">
						<b>Sending email to : <%= request.getAttribute("displayName") %></b>
				</td>
			</tr>
