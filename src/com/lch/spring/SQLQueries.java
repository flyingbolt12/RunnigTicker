...
public interface SQLQueries {
	...
	static final String INSERT_WEEKLY_HRS_SUMMARY = "insert into weeklyhrssummary (  userId ,  businessId,  month,  year,  totalHrsSubmitted,  status,  totalRegularHrs,  totalOvertimeHrs,  submittedDate, clientId, submissionConfiguredTo, submissionFor,totalHolidayHrs,startWeekDate,endWeekDate, categoryId) values (:userId,:businessId,:month,:year,:totalHrsSubmitted,:status,:totalRegularHrs,:totalOvertimeHrs,:submittedDate, :clientId, :submissionConfiguredTo, :submissionFor, :totalHolidayHrs, :startWeekDate, :endWeekDate, :categoryId)";
