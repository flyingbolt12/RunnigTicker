		...
		try {
			...
			if (propBean.getIsToSendEmail()) {
				...
				if (from != null && from.equals(EmailConstants.FROM_EMAIL)) {
					...
					logger.debug("From Not found Dropping the email");
